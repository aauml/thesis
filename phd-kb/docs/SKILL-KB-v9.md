...
2. **Create `SKILL-KB-vN+1.md`** in `/sessions/.../mnt/phd-kb/AppScripts/` with all changes applied. Current version is v9, so next update produces `SKILL-KB-v10.md`.

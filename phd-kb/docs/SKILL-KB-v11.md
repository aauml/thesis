...
2. **Create `SKILL-KB-vN+1.md`** in `/sessions/.../mnt/phd-kb/AppScripts/` with all changes applied. Current version is v11, so next update produces `SKILL-KB-v12.md`.
...
```
Ruta: phd-kb/AppScripts/KB-PendingIssues.md
```
...
**Prevention:** Hard batch limits in v11 (50 items for `update perplexity`). Quality gate before every API post.

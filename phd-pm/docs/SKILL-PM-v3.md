...
**Ubicación canónica:** `09_Sistema/phd-pm/` en Google Drive.
- **Ruta local (Cowork):** `/mnt/PhD/09_Sistema/phd-pm/` — SIEMPRE guardar archivos aquí, NUNCA en la raíz de `/mnt/PhD/`
- **URL Google Drive:** https://drive.google.com/drive/folders/1YRxhs-Y_DtoseHdy1zD_8hKauApGYGHB
- **Ruta completa Drive:** `My Drive/PhD/09_Sistema/phd-pm/`

| Archivo activo | Propósito |
|----------------|-----------|
| `SKILL-PM-v3.md` | Este skill. Sistema operativo del PM. LEER SIEMPRE al inicio. |
| `PM-SessionLog-v3.md` | Log técnico entre sesiones. Leer al inicio, actualizar al cierre. |
...
| `phd-pm-project-instructions-v3.md` | Instrucciones para el campo Instructions del proyecto en Cowork UI. |
...
1. **Crear archivo nuevo** con el siguiente número: `SKILL-PM-v4.md`, `PM-SessionLog-v4.md`, `context-blocks-v3.md`, etc. Nunca editar el archivo anterior.
...
4. **Progreso en Dashboard:** Actualizar sección Progreso si cambió el estado (ver §7b).
5. **Skill/archivos:** Si algún cambio requiere actualizar este skill u otro archivo, crear la siguiente versión en `09_Sistema/phd-pm/` (ver §4).
...
- Poner archivos del PM en la raíz de PhD o en otras rutas — SIEMPRE en `09_Sistema/phd-pm/` (ruta Cowork: `/mnt/PhD/09_Sistema/phd-pm/`)

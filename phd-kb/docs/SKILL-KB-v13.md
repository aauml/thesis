...
4. The user replaces the project knowledge file with the new version.

This ensures the change history is preserved and any version can be recovered (also via `git log`).

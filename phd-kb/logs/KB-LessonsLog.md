...
| 2026-03-22 | data enrichment | Scholar: 266→1,493 (100%) via CrossRef, Semantic Scholar, arXiv APIs + regex + institutional tagging. thesis_relevance: 19 gdrive items completed. Embeddings: all 1,493 complete. Cleanup: 9 items deleted (8 arXiv dups + 1 noise), synced to Sheet via deleteByUrl. BUG-003 confirmed resolved. TASK-008/011/012/013 completed. `chapters` column added and populated (keyword heuristics). Final DB: 1,493 items, ALL fields 100%. | — |

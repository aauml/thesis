...
| 2026-03-22 | data enrichment | Scholar: 266→1,240 (+983) via CrossRef API, Semantic Scholar API, arXiv API, regex, institutional tagging. thesis_relevance: 19 gdrive items completed. Embeddings: 10 remaining generated via edge function (batch_size=1). Cleanup: 9 items deleted (8 arXiv dups + 1 noise). BUG-003 confirmed resolved (0 degraded). TASK-008 completed. Final DB: 1,493 items, 100% thesis_relevance, 100% embeddings, 83% scholar. | — |

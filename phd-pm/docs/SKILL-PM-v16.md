...
### Protecciones de datos — IMPLEMENTADO 2026-03-22

- **Trigger validación estricta** (`trg_validate_evaluated_item`): rechaza items sin title (≥5 chars), url (≥10 chars), importance (ALTA/MEDIA/BAJA), thesis_relevance (≥100 chars, sin patrones degradados), scholar (≥2 chars), o chapters vacíos. NO auto-corrige — rechaza.

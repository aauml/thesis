...
### Estructura canónica de capítulos — ACTUALIZADO 2026-03-22

**Fuente única de verdad:** tabla `chapter_sections` en Supabase (29 secciones en 7 capítulos).

| Cap | Título | Secciones | KB sources | Lecturas asignadas |
|-----|--------|-----------|------------|-------------------|
| 1 | Introducción | 5 | 748 | 0 |
| 2 | Marco teórico | 4 | 726 | 16 |
| 3 | Estado del arte | 5 | 818 | 13 |
| 4 | Metodología | 4 | 37 | 0 |
| 5 | Análisis comparativo | 4 | 574 | 8 |
| 6 | Caso de estudio | 4 | 378 | 7 |
| 7 | Conclusiones | 3 | 0 | 1 |
